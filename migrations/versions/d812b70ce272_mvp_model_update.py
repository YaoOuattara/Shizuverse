...
def upgrade():
    ...
    op.execute("""
        ...
        END $$;
    """)
    op.execute("ALTER TABLE client_bookings ADD COLUMN IF NOT EXISTS payment_status payment_status_enum NOT NULL DEFAULT 'unpaid'")
    op.execute("ALTER TABLE client_bookings ADD COLUMN IF NOT EXISTS payout_status payout_status_enum NOT NULL DEFAULT 'not_due'")
    op.execute("ALTER TABLE client_bookings ADD COLUMN IF NOT EXISTS amount_xof INTEGER")
    ...
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS phone_number VARCHAR(20)")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS address VARCHAR(300)")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS bio TEXT")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS profile_picture VARCHAR(255)")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS verified BOOLEAN DEFAULT FALSE")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS verification_status verification_status_enum NOT NULL DEFAULT 'draft'")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS listed_status listed_status_enum NOT NULL DEFAULT 'unlisted'")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS provider_status provider_status_enum NOT NULL DEFAULT 'paused'")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS rejection_reason VARCHAR(200)")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS rejection_note TEXT")
    op.execute("ALTER TABLE service_providers ADD COLUMN IF NOT EXISTS submitted_at TIMESTAMP")
