  ...
  return (
    <AdminLayout title={isFr ? "Anomalies" : "Anomalies"}>
      <div className="space-y-4">
        {/* AI context label */}
        <p className="text-xs text-muted-foreground bg-muted/60 px-3 py-1.5 rounded-full inline-block">
          {isFr
            ? "Surveillance automatique · Alertes générées par l'IA Shizu"
            : "Automated monitoring · Alerts generated by Shizu AI"}
        </p>
